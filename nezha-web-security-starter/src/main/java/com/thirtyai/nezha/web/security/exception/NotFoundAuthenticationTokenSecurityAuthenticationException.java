...
public class NotFoundAuthenticationTokenSecurityAuthenticationException extends I18nSecurityAuthenticationException {

	public NotFoundAuthenticationTokenSecurityAuthenticationException() {
		super(Status.Security_Token_Type_Not_Found);
	}

	public NotFoundAuthenticationTokenSecurityAuthenticationException(Throwable t) {
