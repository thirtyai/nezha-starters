...
/**
 * Web Server Initialized Event Listener
 *
 * @author kyleju
 */
@Configuration
@Slf4j
public class NezhaWebCoreInitializedListenerConfiguration {
	@Async
	@Order
	...
	public void started(WebServerInitializedEvent event) {
		...
		log.info("///nezha/// web server is running，port:[{}]，profile:[{}]", localPort, profile);
	}
}
