...
public class UploadFileUtil {
	...
	public static boolean testExt(String dir, String fileName) {
		...
		if (StrUtil.isBlank(ext) || ext.indexOf(fileExt) == -1) {
			return false;
		}
		return true;
	}
	 ...
	 * @return UploadFile
	 */
	public static UploadFile getFile(MultipartFile file, NezhaWebProperties.UploadFolderConfig uploadFolderConfig) {
		return getFile(file, uploadFolderConfig, null, null);
	}
	 ...
	 * @return UploadFile
	 */
	public static UploadFile getFile(MultipartFile file, NezhaWebProperties.UploadFolderConfig uploadFolderConfig, String path, String virtualPath) {
		return new UploadFile(file, uploadFolderConfig, path, virtualPath);
	}
	 ...
	 * @return UploadFile
	 */
	public static List<UploadFile> getFiles(List<MultipartFile> files, NezhaWebProperties.UploadFolderConfig uploadFolderConfig) {
		return getFiles(files, uploadFolderConfig, null, null);
	}
	 ...
	 * @return UploadFile
	 */
	public static List<UploadFile> getFiles(List<MultipartFile> files, NezhaWebProperties.UploadFolderConfig uploadFolderConfig, String path, String virtualPath) {
		List<UploadFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new UploadFile(file, uploadFolderConfig, path, virtualPath));
		}
		return list;
	}
